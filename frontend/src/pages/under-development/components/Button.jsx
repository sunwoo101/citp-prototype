...
export default function Button({
    ...
    return (
        <button
            className={`relative w-full text-white rounded-2xl sm:rounded-3xl md:rounded-4xl text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold py-6 sm:py-7 md:py-8 px-4 sm:px-6 md:px-8 leading-none overflow-hidden cursor-pointer`}
        >
